            ...
            <div className="bottom">
                <div className="add">
                    <div className="add__container">
                        ...
                        <input type="text" className="add__description" placeholder="Add description" onChange={this.props.desChange} value={this.props.description} onKeyDown={this.props.keyPress}/>
